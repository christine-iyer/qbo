const customersToImport = [
     ...
     {
          name: "Fresh off the Farm",
          ShipAddr: {
               Line1: "495 Commercial St",
               City: "Rockport",
               CountrySubDivisionCode: "ME",
               PostalCode: "04856"
          },
     ...
     {
          name: "Triple Chick Farm (behind John Edward's)",
          ShipAddr: {
               Line1: " 158 Main St",
               City: "Ellsworth",
               CountrySubDivisionCode: "ME",
     ...
     {
          name: "Darthia Farm (behind John Edward's)",
          ShipAddr: {
               Line1: " 158 Main St",
               City: "Ellsworth",
               CountrySubDivisionCode: "ME",
     ...
     // {
     //      name: "Daybreak Growers Alliance",
     //      ShipAddr: {
     //           Line1: "",
     //           City: "Unity",
     //           CountrySubDivisionCode: "ME",
